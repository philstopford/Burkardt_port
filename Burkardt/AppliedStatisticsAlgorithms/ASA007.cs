...
public static partial class Algorithms
{
        ...
        //
    {
        ...
        {
            int l;
            switch (c[((ndiag - 1) + c.Length) % c.Length])
            {
                case 0.0:
                {
                    l = ndiag;
                ...
                default:
                {
                    ...
                    {
                        w[((i - 1) + w.Length) % w.Length] = c[((l - 1) + c.Length) % c.Length];
                        l += i;
                    }
                    ...
                    for (;;)
                    {
                        ...
                        if (icol == irow)
                        {
                            x = 1.0 / w[((irow - 1) + w.Length) % w.Length];
                        }
                        else
                        {
                            x = 0.0;
                        ...
                        while (irow < k)
                        {
                            x -= w[((k - 1) + w.Length) % w.Length] * c[((l - 1) + c.Length) % c.Length];
                            k -= 1;
                            l -= 1;
                        ...
                        c[((l - 1) + c.Length) % c.Length] = x / w[((irow - 1) + w.Length) % w.Length];
