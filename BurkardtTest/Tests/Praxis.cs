...
public class PraxisTest
{
    ...
    [Test]
    public static void chebyquad_test()
    ...
    [Test]
    public static void hilbert_test()
    ...
    [Test]
    public static void minfit_test()
    ...
    [Test]
    public static void powell3d_test()
    ...
    [Test]
    public static void rosenbrock_test()
    ...
    [Test]
    public static void singular_test()
    ...
    [Test]
    public static void tridiagonal_test()
    ...
    [Test]
    public static void watson_test()
    ...
    [Test]
    public static void svsort_test()
