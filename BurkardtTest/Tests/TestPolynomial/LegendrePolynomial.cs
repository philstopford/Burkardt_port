...
public class LegendrePolynomialTest
{
    ...
    [Test]
    public static void p_exponential_product_test_a()
    {
        p_exponential_product_test(5, 0);
    }

    [Test]
    public static void p_exponential_product_test_b()
    {
        p_exponential_product_test(5, 1);
    }
    
    static void p_exponential_product_test(int p, double b)
    ...
    [Test]
    public static void p_power_product_test_a()
    {
        p_power_product_test(5, 0);
    }

    [Test]
    public static void p_power_product_test_b()
    {
        p_power_product_test(5, 1);
    }
    
    static void p_power_product_test(int p, int e)
    ...
    [Test]
    public static void pn_pair_product_test()
