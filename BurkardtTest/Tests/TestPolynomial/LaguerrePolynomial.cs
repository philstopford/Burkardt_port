...
public class LaguerrePolynomialTest
{
        [Test]
    ...
    {
        laguerre_polynomial_test07(5, 0);
    }
    
    [Test]
    public static void test7b()
    {
        laguerre_polynomial_test07(5, 1);
    }
    
    static void laguerre_polynomial_test07(int p, double b)
    ...
    {
        laguerre_polynomial_test08(5, 0);
    }
    
    [Test]
    public static void test8b()
    {
        laguerre_polynomial_test08(5, 1);
    }
    
    static void laguerre_polynomial_test08(int p, int e)
