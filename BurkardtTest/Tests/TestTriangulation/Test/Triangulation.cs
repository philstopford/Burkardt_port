...
namespace Burkardt_Tests.TestTriangulation.Test;
...
public class TriangulationTest
{
        ...
        //
    {
        ...
        Burkardt.TriangulationNS.Triangulation.triangle_order3_reference_to_physical(t, N, ref_, ref phy);

        Burkardt.TriangulationNS.Triangulation.triangle_order3_physical_to_reference(t, N, phy, ref ref2);
        ...
        //
    {
        ...
        Burkardt.TriangulationNS.Triangulation.triangle_order6_reference_to_physical(t, N, ref_, ref phy);

        Burkardt.TriangulationNS.Triangulation.triangle_order6_physical_to_reference(t, N, phy, ref ref2);
        ...
        //
    {
        ...
        for (test = 1; test <= test_num; test++)
        {
            ...
            //
            Burkardt.TriangulationNS.Quad.triangulation_order3_quad(node_num, node_xy, triangle_order,
        ...
        //
    {
        ...
        for (test = 0; test < TEST_NUM; test++)
        {
            ...
            Burkardt.TriangulationNS.Search.triangulation_search_delaunay_a(ref data, NODE_NUM, node_xy, TRIANGLE_ORDER, triangle_num,
        ...
        //
    {
        ...
        for (test = 0; test < TEST_NUM; test++)
        {
            int triangle_index1 = Burkardt.TriangulationNS.Search.triangulation_search_naive(NODE_NUM, node_xy,
                TRIANGLE_ORDER, triangle_num, triangle_node, p_test, pIndex: + DIM_NUM * test);

            Burkardt.TriangulationNS.Search.triangulation_search_delaunay_a(ref data, NODE_NUM, node_xy, TRIANGLE_ORDER,
