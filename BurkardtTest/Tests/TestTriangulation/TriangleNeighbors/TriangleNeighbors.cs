...
namespace Burkardt_Tests.TestTriangulation.TriangleNeighbors;

public class TriangleNeighborsTest
{
    [Test]
    public static void test1()
    {
        do_test(new []{"big_cavity"});
    }
