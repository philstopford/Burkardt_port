...
{
    [Test]
    public static void square_minimal_rule_print_test()
    ...
    [Test]
    public static void square_minimal_rule_order_test()
    ...
    [Test]
    public static void square_minimal_rule_error_max_test()
