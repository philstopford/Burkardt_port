...
public class NewtonCotesOpenTest
{
        ...
        //
    {
        ...
        int rule_num = NewtonCotesOpen.triangle_nco_rule_num();
        ...
        for (rule = 1; rule <= rule_num; rule++)
        {
            ...
            int degree = NewtonCotesOpen.triangle_nco_degree(rule);
        ...
        //
    {
        ...
        for (rule = 1; rule <= rule_num; rule++)
        {
            int suborder_num = NewtonCotesOpen.triangle_nco_suborder_num(rule);
