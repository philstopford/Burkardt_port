...
{
    [Test]
    public static void i4_to_pascal_test()
    ...
    [Test]
    public static void i4_to_pascal_degree_test()
    ...
    [Test]
    public static void pascal_to_i4_test()
    ...
    [Test]
    public static void poly_power_test()
    ...
    [Test]
    public static void poly_power_linear_test()
    ...
    [Test]
    public static void poly_print_test()
    ...
    [Test]
    public static void poly_product_test()
    ...
    [Test]
    public static void rs_to_xy_map_test()
    ...
    [Test]
    public static void triangle_monomial_integral_test()
    ...
    [Test]
    public static void triangle_poly_integral_test()
    ...
    [Test]
    public static void triangle01_monomial_integral_test()
    ...
    [Test]
    public static void triangle01_poly_integral_test()
    ...
    [Test]
    public static void triangle_xy_integral_test()
    ...
    [Test]
    public static void xy_to_rs_map_test()
