...
{
        [Test]
    public static void pentomino_matrix_test()
    ...
    [Test]
    public static void pentomino_plot_test()
    ...
    [Test]
    public static void polyomino_condense_test()
    ...
    [Test]
    public static void polyomino_embed_list_test()
    ...
    [Test]
    public static void polyomino_embed_number_test()
    ...
    [Test]
    public static void polyomino_enumerate_test()
    ...
    [Test]
    public static void polyomino_enumerate_chiral_test()
    ...
    [Test]
    public static void polyomino_enumerate_fixed_test()
    ...
    [Test]
    public static void polyomino_enumerate_free_test()
    ...
    [Test]
    public static void polyomino_index_test()
    ...
    [Test]
    public static void polyomino_lp_write_test()
    ...
    [Test]
    public static void polyomino_transform_test()
