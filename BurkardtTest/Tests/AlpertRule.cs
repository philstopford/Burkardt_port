...
public class AlpertRuleTest
{
    [Test]
    public static void alpert_log_test()
    ...
    [Test]
    public static void alpert_power_test()
    ...
    [Test]
    public static void alpert_regular_test()
    ...
    [Test]
    public static void monte_carlo_log_test()
    ...
    [Test]
    public static void monte_carlo_power_test()
    ...
    [Test]
    public static void monte_carlo_regular_test()
    ...
    [Test]
    public static void trapezoid_log_test()
    ...
    [Test]
    public static void trapezoid_power_test()
    ...
    [Test]
    public static void trapezoid_regular_test()
