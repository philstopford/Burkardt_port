...
public class CompassSearchTest
{
    ...
    [Test]
    public static void bohach1_test()
    ...
    [Test]
    public static void bohach2_test()
    ...
    [Test]
    public static void broyden_test()
    ...
    [Test]
    public static void extended_rosenbrock_test()
    ...
    [Test]
    public static void goldstein_price_test()
    ...
    [Test]
    public static void himmelblau_test()
    ...
    [Test]
    public static void mckinnon_test()
    ...
    [Test]
    public static void powell_test()
