...
{
        [Test]
    public static void q8_conjugate_test()
    ...
    [Test]
    public static void q8_exponentiate_test()
    ...
    [Test]
    public static void q8_inverse_test()
    ...
    [Test]
    public static void q8_multiply_test()
    ...
    [Test]
    public static void q8_multiply2_test()
    ...
    [Test]
    public static void q8_normal_01_test()
    ...
    [Test]
    public static void q8_norm_test()
    ...
    [Test]
    public static void q8_transpose_print_test()
    ...
    [Test]
    public static void r8vec_uniform_01_new_test()
    ...
    [Test]
    public static void rotation_axis2mat_test()
    ...
    [Test]
    public static void rotation_axis2quat_test()
    ...
    [Test]
    public static void rotation_axis_vector_test()
    ...
    [Test]
    public static void rotation_mat2axis_test()
    ...
    [Test]
    public static void rotation_mat2quat_test()
    ...
    [Test]
    public static void rotation_mat_vector_test()
    ...
    [Test]
    public static void rotation_quat2axis_test()
    ...
    [Test]
    public static void rotation_quat2mat_test()
    ...
    [Test]
    public static void rotation_quat_vector_test()
