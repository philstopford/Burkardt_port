...
public class QualityTest
{
    ...
    [Test]
    public static void test_halton()
    ...
    [Test]
    public static void test_sphere()
    ...
    private static double sphere_measure(int dim_num, int n, double[] z)
