...
namespace Burkardt_Tests.TestSequence;

public class VanderCorputSequenceTest
{
    [Test]
    public static void vdc_base_test()
    ...
    [Test]
    public static void vdc_inverse_test()
    ...
    [Test]
    public static void vdc_sequence_test()
