...
namespace Burkhardt_Tests.TestTetrahedron.PropertiesTest;
...
public class PropertiesTest
{
    ...
    {
        do_test(new []{"tet_cap.txt"});
    }
    
    [Test]
    public static void test2()
    {
        do_test(new []{"tet_equilateral.txt"});
    }
    
    [Test]
    public static void test3()
    {
        do_test(new []{"tet_needle.txt"});
    }
    
    [Test]
    public static void test4()
    {
        do_test(new []{"tet_right.txt"});
    }
    
    [Test]
    public static void test5()
    {
        do_test(new []{"tet_sliver.txt"});
    }
    
    [Test]
    public static void test6()
    {
        do_test(new []{"tet_spindle.txt"});
    }
    
    [Test]
    public static void test7()
    {
        do_test(new []{"tet_wedge.txt"});
    }
    
    private static void do_test(string[] args)
        //****************************************************************************80
        //
        //  Purpose:
        //
