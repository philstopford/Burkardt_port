...
public class TriangleQuadTest
{
        ...
        //
    {
        ...
        for (i = 1; i <= 17; i++)
        {
            ...
            polyterm_exponent("SET", ref e);

            polyterm_exponent("PRINT", ref e);
    ...
    private static void polyterm_exponent(string action, ref int[] e)
