...
namespace Burkardt_Tests.TestPolygon.TriangulateTest;
...
public class TriangulateTest
{
    ...
    [Test]
    public static void test02_3()
    {
        test02("i18");
    }

    [Test]
    public static void test03_1()
    {
        test03("comb");
    }

    [Test]
    public static void test03_2()
    {
        test03("hand");
    }

    [Test]
    public static void test03_3()
    {
        test03("i18");
    }
