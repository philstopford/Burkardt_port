...
namespace Burkardt_Tests.TestQuadrature.GenHermite;

public class IntExactnessGenHermiteTest
{
    [Test]
    public static void test1()
    {
        do_test("gen_herm_o1_a1.0", 5, 1.0, 0);
    }
    
    [Test]
    public static void test2()
    {
        do_test("gen_herm_o2_a1.0", 5, 1.0, 0);
    }
    
    [Test]
    public static void test3()
    {
        do_test("gen_herm_o4_a1.0", 10, 1.0, 0);
    }
    
    [Test]
    public static void test4()
    {
        do_test("gen_herm_o8_a1.0", 18, 1.0, 0);
    }
    
    [Test]
    public static void test5()
    {
        do_test("gen_herm_o16_a1.0", 35, 1.0, 0);
    }
    
    [Test]
    public static void test6()
    {
        do_test("gen_herm_o1_a1.0_modified", 5, 1.0, 1);
    }
    
    [Test]
    public static void test7()
    {
        do_test("gen_herm_o2_a1.0_modified", 5, 1.0, 1);
    }
    
    [Test]
    public static void test8()
    {
        do_test("gen_herm_o4_a1.0_modified", 10, 1.0, 1);
    }
    
    [Test]
    public static void test9()
    {
        do_test("gen_herm_o8_a1.0_modified", 18, 1.0, 1);
    }
    
    [Test]
    public static void test10()
    {
        do_test("gen_herm_o16_a1.0_modified", 35, 1.0, 1);
    }
    
    private static void do_test(string quad_filename, int degree_max, double alpha, int option)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    [Test]
    public static void test_option1()
        //****************************************************************************80
        //
        //  Purpose:
        //
