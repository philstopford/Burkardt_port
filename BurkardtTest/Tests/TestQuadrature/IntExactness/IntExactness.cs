using Burkardt_Tests.TestFeynmanKac;
using Burkardt.Quadrature;
using Burkardt.Table;
using Burkardt.Types;

namespace Burkardt_Tests.TestQuadrature.IntExactnessTest;
...
public class IntExactnessTest
{
    ...
    private static void do_test(string quad_filename, int degree_max)
        //****************************************************************************80
        //
        //  Purpose:
        //
