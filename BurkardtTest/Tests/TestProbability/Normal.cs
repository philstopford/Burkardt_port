...
internal static partial class TestProbability
{
    ...
    [Test]
    public static void normal_01_samples_test()
    ...
    [Test]
    public static void normal_cdf_test()
    ...
    [Test]
    public static void normal_samples_test()
    ...
    [Test]
    public static void normal_truncated_ab_cdf_test()
    ...
    [Test]
    public static void normal_truncated_ab_sample_test()
    ...
    [Test]
    public static void normal_truncated_a_cdf_test()
    ...
    [Test]
    public static void normal_truncated_a_sample_test()
    ...
    [Test]
    public static void normal_truncated_b_cdf_test()
    ...
    [Test]
    public static void normal_truncated_b_sample_test()
