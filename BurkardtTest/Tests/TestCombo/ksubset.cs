...
{
    [Test]
    public static void ksubset_colex_check_test()
    ...
    [Test]
    public static void ksubset_colex_rank_test()
    ...
    [Test]
    public static void ksubset_colex_successor_test()
    ...
    [Test]
    public static void ksubset_colex_unrank_test()
    ...
    [Test]
    public static void ksubset_enum_test()
    ...
    [Test]
    public static void ksubset_lex_check_test()
    ...
    [Test]
    public static void ksubset_lex_rank_test()
    ...
    [Test]
    public static void ksubset_lex_successor_test()
    ...
    [Test]
    public static void ksubset_lex_unrank_test()
    ...
    [Test]
    public static void ksubset_revdoor_rank_test()
    ...
    [Test]
    public static void ksubset_revdoor_successor_test()
    ...
    [Test]
    public static void ksubset_revdoor_unrank_test()
