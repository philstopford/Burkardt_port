...
{
    [Test]
    public static void subset_check_test()
    ...
    [Test]
    public static void subset_colex_rank_test()
    ...
    [Test]
    public static void subset_colex_successor_test()
    ...
    [Test]
    public static void subset_colex_unrank_test()
    ...
    [Test]
    public static void subset_complement_test()
    ...
    [Test]
    public static void subset_distance_test()
    ...
    [Test]
    public static void subset_enum_test()
    ...
    [Test]
    public static void subset_intersect_test()
    ...
    [Test]
    public static void subset_lex_rank_test()
    ...
    [Test]
    public static void subset_lex_successor_test()
    ...
    [Test]
    public static void subset_lex_unrank_test()
    ...
    [Test]
    public static void subset_union_test()
    ...
    [Test]
    public static void subset_weight_test()
    ...
    [Test]
    public static void subset_xor_test()
    ...
    [Test]
    public static void subsetsumswap_test()
