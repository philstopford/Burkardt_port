...
{
    [Test]
    public static void partition_greedy_test()
    ...
    [Test]
    public static void partn_enum_test()
    ...
    [Test]
    public static void partn_sf_check_test()
    ...
    [Test]
    public static void partn_successor_test()
