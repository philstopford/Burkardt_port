...
{
    [Test]
    public static void perm_check_test()
    ...
    [Test]
    public static void perm_enum_test()
    ...
    [Test]
    public static void perm_to_cycle_test()
    ...
    [Test]
    public static void perm_inv_test()
    ...
    [Test]
    public static void perm_lex_rank_test()
    ...
    [Test]
    public static void perm_lex_successor_test()
    ...
    [Test]
    public static void perm_lex_unrank_test()
    ...
    [Test]
    public static void perm_mul_test()
    ...
    [Test]
    public static void perm_parity_test()
    ...
    [Test]
    public static void perm_print_test()
    ...
    [Test]
    public static void perm_random_test()
    ...
    [Test]
    public static void perm_tj_rank_test()
    ...
    [Test]
    public static void perm_tj_successor_test()
    ...
    [Test]
    public static void perm_tj_unrank_test()
