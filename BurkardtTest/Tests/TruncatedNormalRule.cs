...
public class TruncatedNormalRule
{
    [Test]
    public static void test1()
    {
        string[] args = new[] { "0", "128", "0.5", "0.3", "0", "1", "notruncation" };
        do_stuff(args);
    }
    ...
    {
        string[] args = new[] { "1", "128", "0.5", "0.3", "0", "1", "lower" };
        do_stuff(args);
    }
    ...
    {
        string[] args = new[] { "2", "128", "0.5", "0.3", "0", "1", "upper" };
        do_stuff(args);
    }
    ...
    {
        string[] args = new[] { "3", "128", "0.5", "0.3", "0", "1", "both" };
        do_stuff(args);
    }
