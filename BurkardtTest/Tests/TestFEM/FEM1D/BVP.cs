...
namespace Burkardt_Tests.TestFEM.FEM1D;
...
//
        ...
        double[] u =
            FEM_1D_BVP.fem1d_bvp_linear(n, FEM_Test_Methods.a00, FEM_Test_Methods.c00, FEM_Test_Methods.f00, x);
...
//
    {
        ...
        for (e_log = 0; e_log <= e_log_max; e_log++)
        {
            ...
            double[] u = FEM_1D_BVP.fem1d_bvp_linear(n, FEM_Test_Methods.a10, FEM_Test_Methods.c10,
                FEM_Test_Methods.f10,
                x);
        ...
        for (e_log = 0; e_log < e_log_max; e_log++)
        {
            ...
            Console.WriteLine("  " + e_log.ToString(CultureInfo.InvariantCulture).PadLeft(4)
                                   + "  " + ne1.ToString(CultureInfo.InvariantCulture).PadLeft(4) + " /" +
                                   ne2.ToString(CultureInfo.InvariantCulture).PadLeft(4)
                                   + "  " + l2.ToString(CultureInfo.InvariantCulture).PadLeft(14)
                                   + "  " + h1.ToString(CultureInfo.InvariantCulture).PadLeft(14)
                                   + "  " + mx.ToString(CultureInfo.InvariantCulture).PadLeft(14) + "");
        }
